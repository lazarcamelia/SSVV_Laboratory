...
public class IntegrationTests {
    ...
    @Test
    public void tc_big_bang_addStudent() {
    ...
    @Test
    public void tc_big_bang_addTheme() {
    ...
    @Test
    public void tc_big_bang_addNota() {
        Validator<Student> studentValidator = new StudentValidator();
        Validator<Tema> temaValidator = new TemaValidator();
        ...
        try {
            // delete tema
            notaRepository.delete(new Pair<>("2", "1"));
        } catch (Exception ex) {
            // do nothing
        }

        assertEquals(1, service.saveNota("2", "1", 9, 7, "super"));
    }

    @Test
    public void tc_big_bang_integrateAll() {
        Validator<Student> studentValidator = new StudentValidator();
        Validator<Tema> temaValidator = new TemaValidator();
        Validator<Nota> notaValidator = new NotaValidator();
